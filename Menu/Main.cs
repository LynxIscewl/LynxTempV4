...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
            ...
            // Buttons
                // Disconnect
                    if (disconnectButton)
                    {
                        ...
                        disconnectbutton.GetComponent<Renderer>().material.color = buttonColors[0].colors[0].color; disconnectbutton.GetComponent<Renderer>().material.color = new Color(0.745f, 0.541f, 0.733f);
                ...
                // Page Buttons
                    ...
                    gameObject.transform.localPosition = new Vector3(0.56f, 0.6f, -0.6f);
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.transform.parent = menu.transform;
            gameObject.transform.rotation = Quaternion.identity;
            gameObject.transform.localScale = new Vector3(0.09f, 1.4f, 0.08f);
